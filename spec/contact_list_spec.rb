...
describe Promoter::ContactList do
  ...
  it 'returns all contact lists' do
    ...
    result = promoter.contact_list.all
  ...
  it 'returns all contacts for the contact list' do
    ...
    contact_list = promoter.contact_list.contact_ids_for(1)
  ...
  it 'removes a contact from a contact list' do
    ...
    response = promoter.contact_list.remove_contact(contact_list_id: 23,
                                                  contact_id: 77)
  ...
  it 'creates a contact list' do
    ...
    contact_list = promoter.contact_list.create(name: "My Contact List")
  ...
  it 'removes a contact from all lists' do
    ...
    response = promoter.contact_list.remove_contact(email: "kate@mac.com")
